...
class AgentMetadata(_common.BaseModel):
    ...
    function_declarations: Optional[genai_types.ToolListUnion] = Field(
        default=None, description="""Function declarations."""
    )
...
class AgentMetadataDict(TypedDict, total=False):
    ...
    function_declarations: Optional[genai_types.ToolListUnionDict]
...
class EvalCase(_common.BaseModel):
    ...
    responses: Optional[list[ResponseCandidate]] = Field(
        default=None,
        description="""Model-generated replies to the last user message in a single-turn / multi-turn conversation.. Multiple responses are allowed to support use cases such as comparing different model outputs.""",
    )
    reference: Optional[ResponseCandidate] = Field(
        default=None,
        description="""User-provided, golden reference model reply to prompt in context of chat history; Reference for last response in a single-turn /multi-turn conversation.""",
    )
    system_instruction: Optional[genai_types.Content] = Field(
...
class EvalCaseDict(TypedDict, total=False):
    ...
    """Model-generated replies to the last user message in a single-turn / multi-turn conversation.. Multiple responses are allowed to support use cases such as comparing different model outputs."""

    reference: Optional[ResponseCandidateDict]
    """User-provided, golden reference model reply to prompt in context of chat history; Reference for last response in a single-turn /multi-turn conversation."""
